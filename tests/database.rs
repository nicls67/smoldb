...
fn basic_ops_1() -> Result<(), String> {
    ...
    let mut values = vec![Some("hey".to_string()), None, Some("2.23".to_string()), Some("30/04/2020".to_string())];
    ...
    // Add a 3rd entry
    let mut values = vec![Some("what".to_string()), None, Some("-102.56".to_string()), Some("14/07/2022".to_string())];

...
A database contains one or many tables, each tables containing one or many database fields. Tables and fields name (keys) are defined during initialization process.
